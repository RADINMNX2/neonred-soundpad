...
export const translations = {
  en: {
    ...
    playbackError: "Couldn't play this track — unplayable or corrupted file",
    dismiss: "Dismiss",
    equalizer: "Equalizer",
    lyrics: "Lyrics",
    eqProfiles: "Profiles",
    saveProfile: "Save Profile",
    playlistSearchPlaceholder: "Search playlist...",
    playlistNoResults: "No matching tracks",
    playlistClearSearch: "Clear search",
    ...
    libraryBtn: "Library",
    libraryScannedDirs: "Scanned Folders",
    libraryRemove: "Remove",
    libraryAddFolderDesc: "Scan a folder & play straight in place",
    libraryAddFilesDesc: "Pick individual audio files",
    ...
    updateAvailableDesc: "A fresh NeonRed SoundPad version just landed. Download & install it now?",
    updateYes: "YES, UPDATE",
    updateLater: "LATER",
    updateWait: "PLEASE WAIT...",
    updateInstall: "RESTART & INSTALL",
    updateSpeed: "Speed",
    updateRemaining: "Remaining",
    updatePhaseNew: "NEW VERSION",
    updatePhaseDl: "DOWNLOADING",
    updatePhaseReady: "UPDATE READY",
    updateOf: "of",
    updateDiff: "Smart differential update — only changed bytes, low data usage",
    updateDiffDl: "Differential engine — only changed bytes",
    micEqResponseCurve: "RESPONSE CURVE",
    micEqLive: "LIVE",
    micEqDspActive: "Real-time Mic Audio DSP Processing Active",
    micEqUnsaved: "UNSAVED",
    micEqAxisDown: "↓ −12dB",
    micEqAxisUp: "+12dB ↑",
    ...
    welcomeDesc: "Complete Setup Guide",
    ...
    // Wizard (HelpModal) - Neon Glass Wizard
    wizardStepLabel: "Step {current} of {total}",
    wizardProgressLabel: "Setup progress",
    wizardSummaryTitle: "You're All Set!",
    wizardSummaryDesc: "Here's what we configured:",
    wizardRestartNote: "Remember to restart your PC after installing VB-CABLE.",
    wizardNoDevices: "No devices detected. Try again or configure manually.",
    wizardRetry: "Retry",
    wizardDone: "Done",
    wizardGoToStep: "Go to step {n}: {title}",
    wizardStepIncomplete: "Complete this step to continue",
    vbCableDriver: "VB-CABLE Driver",
    vbAudioSoftware: "VB-Audio Software",
    windowsInput: "Windows Input",
    windowsOutput: "Windows Output",
    realMic: "Real Mic",
    headphones: "Headphones",
    rescan: "Re-scan",
    voiceVideoSettings: "Voice & Video Settings",
    discordAdvancedPath: "Discord > User Settings > Voice & Video > Advanced",
  ...
  fa: {
    ...
    libraryBtn: "کتاب‌خونه",
    libraryScannedDirs: "پوشه‌های اسکن‌شده",
    libraryRemove: "حذف",
    libraryAddFolderDesc: "اسکن پوشه و پخش مستقیم از همون‌جا",
    libraryAddFilesDesc: "انتخاب فایل‌های صوتی جداگانه",

    // Software Update
    updateTitle: "آپدیت برنامه",
    updateAvailable: "نسخهٔ جدید موجوده!",
    updateReady: "نسخهٔ جدید آماده‌ست!",
    updateDownloading: "در حال دانلود...",
    updateAvailableDesc: "یه نسخهٔ جدید از NeonRed SoundPad منتشر شده. می‌خوای همین الان دانلود و نصبش کنی؟",
    updateYes: "آره، آپدیت کن",
    updateLater: "بعداً",
    updateWait: "لطفاً صبر کن...",
    updateInstall: "ریستارت و نصب",
    updateSpeed: "سرعت",
    updateRemaining: "مونده",
    updatePhaseNew: "نسخهٔ جدید",
    updatePhaseDl: "در حال دانلود",
    updatePhaseReady: "آپدیت آماده",
    updateOf: "از",
    updateDiff: "آپدیت هوشمند بخشی — فقط بایت‌های تغییرکرده دانلود می‌شه، مصرف اینترنت خیلی کم",
    updateDiffDl: "موتور بخشی — فقط بایت‌های تغییرکرده",
    ...
    playbackError: "پخش این قطعه ممکن نشد — فایل خراب یا غیرقابل‌پخش است",
    dismiss: "بستن",
    equalizer: "اکولایزر",
    lyrics: "متن آهنگ",
    eqProfiles: "پروفایل‌ها",
    saveProfile: "ذخیره پروفایل",
    playlistSearchPlaceholder: "جستجو در لیست پخش...",
    playlistNoResults: "آهنگی مطابق پیدا نشد",
    playlistClearSearch: "پاک کردن جستجو",
    unknownAlbum: "آلبوم ناشناس",
    removeTrack: "حذف از لیست پخش",
    trackDetails: "جزئیات",
    playNow: "پخش کن",
    dragHint: "برای جابه‌جایی بکش",
    addingTracks: "در حال افزودن آهنگ‌ها...",
    micEqResponseCurve: "منحنی پاسخ فرکانسی",
    micEqLive: "زنده",
    micEqDspActive: "پردازش همزمان DSP میکروفون فعال است",
    micEqUnsaved: "ذخیره نشده",
    micEqAxisDown: "↓ −12dB",
    micEqAxisUp: "+12dB ↑",
    ...
    welcomeDesc: "راهنمای کامل راه‌اندازی",
    whySetup: "داستان چیه؟",
    ...
    // Wizard (HelpModal) - نئون گلس
    wizardStepLabel: "مرحله {current} از {total}",
    wizardProgressLabel: "پیشرفت راه‌اندازی",
    wizardSummaryTitle: "همه‌چیز آماده‌ست!",
    wizardSummaryDesc: "این چیزیه که تنظیم کردیم:",
    wizardRestartNote: "یادت نره بعد از نصب کابل مجازی، سیستم رو ریستارت کنی.",
    wizardNoDevices: "هیچ دیوایسی پیدا نشد. دوباره تلاش کن یا دستی تنظیم کن.",
    wizardRetry: "تلاش دوباره",
    wizardDone: "تمام",
    wizardGoToStep: "برو به مرحله {n}: {title}",
    wizardStepIncomplete: "برای ادامه، این مرحله رو کامل کن",
    vbCableDriver: "درایور VB-CABLE",
    vbAudioSoftware: "نرم‌افزار VB-Audio",
    windowsInput: "ورودی ویندوز",
    windowsOutput: "خروجی ویندوز",
    realMic: "میکروفون اصلی",
    headphones: "هدفون",
    rescan: "اسکن دوباره",
    voiceVideoSettings: "تنظیمات صدا و تصویر",
    discordAdvancedPath: "دیسکورد > تنظیمات کاربر > صدا و تصویر > بخش Advanced",
